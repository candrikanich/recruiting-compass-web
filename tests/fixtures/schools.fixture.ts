 ...
 */
export function createMockSchools(count: number, overrideFn?: (index: number) => Partial<School>): School[] {
 ...
 */
export function createMockSchoolPreference(overrides: Partial<SchoolPreference> = {}): SchoolPreference {
  return {
 ...
 */
export function createSchoolWithAcademics(academicOverrides: Partial<School['academic_info']> = {}, schoolOverrides: Partial<School> = {}): School {
...
export const createEliteSchool = (overrides?: Partial<School>): School =>
  createMockSchool({
    ...
    academic_info: { admission_rate: 0.04, enrollment: 8000, gpa_requirement: 3.9 },
    ...overrides,
  })
...
export const createMidTierSchool = (overrides?: Partial<School>): School =>
  createMockSchool({
    ...
    division: 'D1',
    conference: 'Pac-12',
    academic_info: { admission_rate: 0.40, enrollment: 30000, gpa_requirement: 3.3 },
    ...overrides,
  })
...
export const createAccessibleSchool = (overrides?: Partial<School>): School =>
  createMockSchool({
    ...
    academic_info: { admission_rate: 0.75, enrollment: 8000, gpa_requirement: 2.8 },
    ...overrides,
  })
...
export const createJucoSchool = (overrides?: Partial<School>): School =>
  createMockSchool({
    ...
    division: 'JUCO',
    conference: null,
    academic_info: { admission_rate: 0.90, enrollment: 3000 },
    ...overrides,
  })
...
export const createNortheastSchools = (): School[] => [
  createMockSchool({ state: 'MA', location: 'Boston, MA', name: 'Boston College' }),
  createMockSchool({ state: 'PA', location: 'Philadelphia, PA', name: 'University of Pennsylvania' }),
  createMockSchool({ state: 'NY', location: 'New York, NY', name: 'Columbia University' }),
]

export const createSoutheastSchools = (): School[] => [
  createMockSchool({ state: 'FL', location: 'Gainesville, FL', name: 'University of Florida' }),
  createMockSchool({ state: 'GA', location: 'Athens, GA', name: 'University of Georgia' }),
  createMockSchool({ state: 'NC', location: 'Chapel Hill, NC', name: 'UNC Chapel Hill' }),
]

export const createWestSchools = (): School[] => [
  createMockSchool({ state: 'CA', location: 'Berkeley, CA', name: 'UC Berkeley' }),
  createMockSchool({ state: 'AZ', location: 'Tempe, AZ', name: 'Arizona State' }),
  createMockSchool({ state: 'WA', location: 'Seattle, WA', name: 'University of Washington' }),
]
...
export const createMountainWestSchool = (overrides?: Partial<School>): School =>
  createMockSchool({ conference: 'Mountain West', division: 'D1', ...overrides })
