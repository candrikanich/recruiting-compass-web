...
export const freshmanTasks = [
  // Academic Tasks (3)
  {
    ...
    description: 'Learn college eligibility basics. Review NCAA core-course rules. Confirm counselor about your path.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Avoids eligibility mistakes early. Wrong courses freshman year compound into senior year problems.',
    failure_risk: 'Weak grades in non-core classes = options reduced. May need extra courses senior year.',
  ...
  },
  {
    ...
    description: 'Establish consistent study routine. Aim for A/B grades minimum. Track unweighted GPA.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Early grades compound; hard to fix later. GPA is cumulative across all 4 years.',
    failure_risk: 'GPA <2.8 closes most D1/D2 options. Recovery requires near-perfect later grades.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-a3',
    ...
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Gives 3 years to improve test scores. Baseline helps target prep areas.',
    failure_risk: 'Late testing = rushed senior year. No baseline means blind prep later.',
  ...
  // Athletic Development Tasks (3)
  {
    ...
    description: 'In-season play + off-season training. Establish strength/speed routine.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Athletic gap closes at higher levels. Consistent training compounds over 4 years.',
    failure_risk: 'Seasonal athletes get left behind. Peers who train year-round gain significant advantage.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-at2',
    ...
    description: 'Record height, weight, basic stats. Games played, key performances. Speed/strength benchmarks.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Coaches need objective data. Tracking shows trajectory, not just snapshots.',
    failure_risk: 'Coaches have no proof of development. Claims without data are ignored.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-at3',
    ...
    description: 'Ask high school/club coach: "Where do I realistically fit?" Accept honest assessment.',
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Prevents chasing unrealistic levels. Sets appropriate expectations early.',
    failure_risk: 'Wasting energy on impossible targets. Family invests in wrong showcases.',
    division_applicability: ['ALL'],
  },
  ...
  // Film & Exposure Tasks (6)
  {
    ...
    description: 'Ask parents/team staff/friends to record games. Save raw clips (no editing needed yet).',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Builds raw material for highlight video later. Best plays may happen anytime.',
    failure_risk: 'Senior year scramble if no footage exists. Can\'t recreate past moments.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-f2',
    ...
    description: 'Name, graduation year, sport, position. Height, weight, current teams, GPA. Contact info.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Standardizes your intro. Professional presentation from day one.',
    failure_risk: 'Unprofessional first impression. Coaches dismiss unorganized athletes.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-f3',
    ...
    description: 'Google Drive shared folder OR Hudl account. Link game clips + resume.',
    required: false,
    dependency_task_ids: ['task-9-f1', 'task-9-f2'],
    why_it_matters: 'Centralizes info for coaches. One link to share everything.',
    failure_risk: 'Scattered info = coaches can\'t find you. Lost opportunities from disorganization.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-e1',
    ...
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Learn environment without pressure. Skill development is primary goal.',
    failure_risk: 'Too many camps = distraction, cost. Focus on development, not exposure.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-9-e2',
    ...
    description: 'Live or streaming; notice size/speed/style differences. Observe D1 vs D2 vs D3 vs NAIA vs JUCO.',
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Calibrate realistic levels. Understand what each division looks like.',
    failure_risk: 'Chasing unrealistic standard. Disappointment when reality doesn\'t match expectations.',
    division_applicability: ['ALL'],
  },
  ...
  // Mindset Tasks (1)
  {
    ...
    description: 'This year is foundation, not evaluation. Recruiting accelerates junior/senior year.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Reduces panic; frames effort correctly. Sets realistic timeline expectations.',
    failure_risk: 'Burnout from unrealistic expectations. Pressure too early causes dropout.',
    division_applicability: ['ALL'],
  },
]
...
export const sophomoreTasks = [
  // Academic Tasks (2)
  {
    ...
    description: 'Meet counselor; verify schedule meets requirements. Maintain strong GPA.',
    required: true,
    dependency_task_ids: ['task-9-a1'],
    why_it_matters: 'Locks in eligibility path. Course requirements can\'t be fixed retroactively.',
    failure_risk: 'Wrong courses = delayed eligibility. May need summer school or extra year.',
    division_applicability: ['DI', 'DII', 'NAIA'],
  },
  {
    id: 'task-10-a2',
    ...
    description: 'Establish baseline; identify weak areas. Use results to target prep.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Two more years to improve. Baseline informs test prep strategy.',
    failure_risk: 'No baseline = can\'t track improvement. Rushed prep junior/senior year.',
    division_applicability: ['DI', 'DII', 'NAIA'],
  },
  ...
  // Athletic Development Tasks (3)
  {
    ...
    description: 'Structured off-season program. Position-specific skill focus.',
    required: true,
    dependency_task_ids: ['task-9-at1'],
    why_it_matters: 'Measurable improvement impresses coaches. Physical development is critical.',
    failure_risk: 'Flat development = coaches lose interest. Peers pass you by.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-at2',
    ...
    description: 'Move to club/travel league if ready. Play against better competition.',
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Coaches want to see you against elite players. Level of competition matters.',
    failure_risk: 'Dominating weak competition looks different on film. Coaches discount stats.',
  ...
  },
  {
    ...
    why_it_matters: 'Shows trajectory, not snapshot. Coaches track improvement over time.',
    failure_risk: 'Outdated info = coaches underestimate. Old numbers hurt your case.',
    division_applicability: ['ALL'],
  },
  ...
  // Recruiting Prep Tasks (5)
  {
    ...
    description: 'Best plays first. Clear jersey number visible. High-quality audio/visuals.',
    required: true,
    dependency_task_ids: ['task-9-f1'],
    why_it_matters: 'First real recruiting tool coaches see. Most important piece of content.',
    failure_risk: 'Bad video = coaches don\'t watch full game footage. One chance at first impression.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-r2',
    ...
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'First impression of communication. Professional emails get responses.',
    failure_risk: 'Unprofessional email = ignored. Form letters are immediately deleted.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-r3',
    ...
    description: 'Research reach, match, safety schools. Mix of DI, DII, DIII, NAIA, JUCO.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Prevents last-minute scramble. Diverse list ensures options.',
    failure_risk: 'Too narrow list = limited options. All reaches = likely disappointment.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-r4',
    ...
    why_it_matters: 'Gets you in system early. Coaches search questionnaire database.',
    failure_risk: 'Coaches don\'t know you exist yet. Missing from their recruiting pool.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-r5',
    ...
    description: 'Use template: intro + academics + athletics + video + schedule. Email 3-5 coaches per month.',
    required: true,
    dependency_task_ids: ['task-10-r1', 'task-10-r2'],
    why_it_matters: 'Early contact = early visibility. Starts the relationship.',
    failure_risk: 'No outreach = coaches forget about you. Silent athletes don\'t get recruited.',
    division_applicability: ['ALL'],
  },
  ...
  // Exposure Tasks (3)
  {
    ...
    description: 'Location, academics, cost, team culture. Watch game film; check rosters.',
    required: true,
    dependency_task_ids: ['task-10-r3'],
    why_it_matters: 'Builds informed list. Know what you\'re pursuing.',
    failure_risk: 'Chasing schools that don\'t fit. Wasted effort on poor matches.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-e2',
    ...
    description: 'Like, comment appropriately (not spam). Engage genuinely with content.',
    required: false,
    dependency_task_ids: ['task-10-r3'],
    why_it_matters: 'Coaches notice engaged accounts. Shows genuine interest.',
    failure_risk: 'No engagement = less visible. Passive following doesn\'t stand out.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-10-e3',
    ...
    description: 'Self-guided or casual; low-cost. Get feel for campus environment.',
    required: false,
    dependency_task_ids: ['task-10-r3'],
    why_it_matters: 'See if campus feels right. Environment matters for 4 years.',
    failure_risk: 'Wrong environment = wrong fit. Committing blind leads to transfers.',
    division_applicability: ['ALL'],
  },
  ...
  // Mindset Tasks (1)
  {
    ...
    description: 'Contacts, responses, interest level. Next steps for each school.',
    required: true,
    dependency_task_ids: ['task-10-r5'],
    why_it_matters: 'Prevents losing track of conversations. Organization is competitive advantage.',
    failure_risk: 'Disorganization = missed opportunities. Can\'t manage what you don\'t track.',
    division_applicability: ['ALL'],
  },
]
...
export const juniorTasks = [
  // Academic Tasks (4)
  {
    ...
    description: 'DI/DII bound athletes. Provide transcripts and test scores (code 9999).',
    required: true,
    dependency_task_ids: ['task-10-a1'],
    why_it_matters: 'Initiates official eligibility tracking. Required for D1/D2 recruitment.',
    failure_risk: 'Late registration delays evaluation. Coaches can\'t officially recruit you.',
    division_applicability: ['DI', 'DII'],
  },
  {
    id: 'task-11-a2',
  ...
  },
  {
    ...
    description: 'Send scores to colleges + eligibility centers. Use college code 9999 for NCAA.',
    required: true,
    dependency_task_ids: ['task-10-a2'],
    why_it_matters: 'Official scores needed for admissions. Eligibility centers require official scores.',
    failure_risk: 'Late testing = rushed deadlines. May miss early application windows.',
    division_applicability: ['DI', 'DII', 'NAIA'],
  },
  {
    id: 'task-11-a4',
    ...
    description: 'Junior year is most important for admissions. Aim for highest grades in core courses.',
    required: true,
    dependency_task_ids: ['task-9-a2'],
    why_it_matters: 'Admissions committees weight junior year heavily. Last full year before applications.',
    failure_risk: 'Weak junior year = admissions rejection even if recruited. GPA must be competitive.',
    division_applicability: ['ALL'],
  },
  ...
  // Athletic Development Tasks (5)
  {
    ...
    description: 'Add new best plays. Keep 3-5 minutes. Show most recent performance.',
    required: true,
    dependency_task_ids: ['task-10-r1'],
    why_it_matters: 'Coaches want recent film. Outdated video shows old abilities.',
    failure_risk: 'Outdated video = old assessment. Coaches assume no improvement.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-at2',
    ...
    description: 'Height, weight, 40-time, lift numbers. Season and career stats.',
    required: true,
    dependency_task_ids: ['task-10-at3'],
    why_it_matters: 'Coaches compare against peers. Current data needed for evaluation.',
    failure_risk: 'Unknown measurables = harder to evaluate. Coaches skip incomplete profiles.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-at3',
    ...
    description: 'Attend only where target schools recruit. Not every big showcase.',
    required: false,
    dependency_task_ids: ['task-10-r3'],
    why_it_matters: 'Cost + value alignment. Quality over quantity.',
    failure_risk: 'Wasting money on wrong events. Target schools may not attend.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-at4',
    ...
    description: 'High-level tournaments and games. Seek out elite competition.',
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Coaches see you against elite. Performance against top players matters.',
    failure_risk: 'Weak schedule = coaches doubt level. Stats against bad teams don\'t impress.',
    division_applicability: ['DI', 'DII'],
  },
  {
    id: 'task-11-at5',
    ...
    description: 'High school/club coach calls on your behalf. Third-party validation.',
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Coach credibility helps. Coaches trust other coaches.',
    failure_risk: 'No third-party validation feels weak. Self-promotion has limits.',
    division_applicability: ['ALL'],
  },
  ...
  // Recruiting Execution Tasks (7)
  {
    ...
    description: 'Every 4-6 weeks to target coaches. Include: new film, stats, schedule, academic updates.',
    required: true,
    dependency_task_ids: ['task-10-r5'],
    why_it_matters: 'Keeps you top-of-mind. Consistent communication builds relationships.',
    failure_risk: 'Forgotten if silent. Coaches move on to responsive athletes.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-r2',
    ...
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Shows seriousness and respect. Responsiveness signals interest.',
    failure_risk: 'Slow response = perceived disinterest. Coaches interpret silence negatively.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-r3',
    ...
    failure_risk: 'Never visiting = can\'t build relationship. Coaches question commitment.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-r4',
    ...
    description: 'Identify reach/match/safety tiers. Focus on programs showing consistent interest.',
    required: true,
    dependency_task_ids: ['task-10-r3', 'task-11-r1'],
    why_it_matters: 'Prevents wasted energy. Quality engagement over quantity.',
    failure_risk: 'Too many targets = shallow execution. Can\'t build deep relationships.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-r5',
    ...
    description: 'Check depth chart; understand your fit. When do current athletes graduate?',
    required: true,
    dependency_task_ids: ['task-10-e1'],
    why_it_matters: 'Know if position opportunity exists. Don\'t pursue stacked positions.',
    failure_risk: 'Committing when position is full. No playing time for 3 years.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-r6',
    ...
    description: 'Many D3 official visits begin Jan 1 of junior year. D1 varies by sport.',
    required: false,
    dependency_task_ids: ['task-11-r3'],
    why_it_matters: 'School pays; serious recruitment. Official visits signal real interest.',
    failure_risk: 'Missing visit window = less serious interest. Timing matters.',
  ...
  },
  {
    ...
    description: 'School, coach, dates, responses, next steps. Comprehensive tracking.',
    required: true,
    dependency_task_ids: ['task-10-m1'],
    why_it_matters: 'Never lose track of status. Professional organization.',
    failure_risk: 'Losing track of conversations. Dropped balls lose opportunities.',
    division_applicability: ['ALL'],
  },
  ...
  // Exposure Tasks (2)
  {
    ...
    failure_risk: 'Wrong events = no scout eyes. Money wasted on irrelevant showcases.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-11-e2',
    ...
    why_it_matters: 'Coaches want to see full context. Highlights + full games together.',
    failure_risk: 'Can\'t provide = coaches less interested. Missing piece of evaluation.',
    division_applicability: ['ALL'],
  },
  ...
  // Mindset Tasks (2)
  {
    ...
    description: 'Elite programs fill most spots by end of junior year. Many athletes get early verbal commitments.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Realistic expectation-setting. Urgency is real.',
    failure_risk: 'Thinking spots still available senior year. Top programs are full.',
    division_applicability: ['DI', 'DII'],
  },
  {
    id: 'task-11-m2',
    ...
    why_it_matters: 'Prevents heartbreak and provides options. Backup plans are essential.',
    failure_risk: 'No acceptable fallback = bad decision under pressure. Panic leads to poor choices.',
    division_applicability: ['ALL'],
  },
]
...
export const seniorTasks = [
  // Academic Tasks (4)
  {
    ...
    description: 'Performance still matters for admissions. Finish remaining NCAA core courses.',
    required: true,
    dependency_task_ids: ['task-11-a4'],
    why_it_matters: 'Admissions committees see senior grades. Senioritis can cost admission.',
    failure_risk: 'Senior slump = admissions rejection. Offers can be rescinded.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-a2',
    ...
    description: 'Submit by deadlines. Required for financial aid consideration.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Determines financial aid package. Money left on table otherwise.',
    failure_risk: 'Late FAFSA = reduced aid. Missed deadlines mean missed money.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-a3',
    ...
    description: 'Send to schools + eligibility centers. Official documents required.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Required for admissions. Official transcripts needed.',
    failure_risk: 'Missing documents = incomplete application. Applications rejected.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-a4',
    ...
    description: 'Confirm with eligibility center. Ensure all requirements met.',
    required: true,
    dependency_task_ids: ['task-11-a1', 'task-11-a3'],
    why_it_matters: 'No surprises at signing. Eligibility must be confirmed.',
    failure_risk: 'Last-minute ineligibility = loss of offer. Nightmare scenario.',
    division_applicability: ['DI', 'DII', 'NAIA'],
  },
  ...
  // Recruiting Finalization Tasks (7)
  {
    ...
    required: true,
    dependency_task_ids: ['task-11-at1'],
    why_it_matters: 'Coaches make final decisions in-season. Current performance matters.',
    failure_risk: 'Late momentum lost if silent. Fall performance often determines fate.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-r2',
    ...
    description: 'Schedule before decisions firm. Meet coaching staff and team.',
    required: true,
    dependency_task_ids: ['task-11-r6'],
    why_it_matters: 'Meet coaching staff and team. Final evaluation opportunity.',
  ...
  },
  {
    ...
    description: 'Playing time path. Role expectations. Academic support. Total cost. Coaching stability.',
    required: true,
    dependency_task_ids: ['task-12-r2'],
    why_it_matters: 'Realistic expectation-setting. Know what you\'re committing to.',
    failure_risk: 'Surprise disappointment first year. Unmet expectations lead to transfers.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-r4',
    ...
    description: 'Full scholarship vs partial vs need-based vs academic aid vs roster spot vs walk-on.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Legally and financially different. Know exactly what\'s offered.',
    failure_risk: 'Misunderstanding financial reality. Sticker shock at enrollment.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-r5',
    ...
    description: 'Cost after aid, playing time, academics, distance, culture. Objective comparison.',
    required: true,
    dependency_task_ids: ['task-12-r4'],
    why_it_matters: 'Rational comparison prevents wrong choice. Data over emotion.',
    failure_risk: 'Emotional decision under pressure. Regret from hasty choices.',
    division_applicability: ['ALL'],
  },
  {
    id: 'task-12-r6',
    ...
    description: 'Football: December (early) + February (regular). Basketball: November + spring. Other sports vary.',
    required: true,
    dependency_task_ids: [],
    why_it_matters: 'Don\'t miss signing window. Timing is everything.',
    failure_risk: 'Offer expires; can\'t sign. Missed window = missed opportunity.',
    division_applicability: ['DI', 'DII'],
  },
  {
    id: 'task-12-r7',
    ...
    required: false,
    dependency_task_ids: [],
    why_it_matters: 'Maintains relationships; shows respect. Sports world is small.',
    failure_risk: 'Burned bridges; regrets later. May need those relationships.',
    division_applicability: ['ALL'],
  },
  ...
  // Decision Tasks (3)
  {
    ...
    description: 'Consider: long-term fit, coaching stability, academic major strength, location/size, cost, playing time.',
    required: true,
  ...
  },
  {
    ...
    failure_risk: 'Offer can be pulled if not documented. Verbal isn\'t binding.',
    division_applicability: ['ALL'],
  },
  ...
  },
  {
    ...
    required: true,
    dependency_task_ids: ['task-12-d3'],
    why_it_matters: 'Coaches expect commitment post-verbal. Show you\'re serious.',
  ...
  },
  {
    ...
    description: 'Understand college pace is faster. You\'ll likely redshirt or be backup initially.',
    required: false,
    dependency_task_ids: ['task-12-d3'],
    why_it_matters: 'Mental prep = better adjustment. Realistic expectations.',
    failure_risk: 'Surprise disappointment first year. Unrealistic expectations cause problems.',
    division_applicability: ['ALL'],
  },
]
...
export const testSuggestions = {
  interactionGap: {
    ...
    urgency: 'high',
    message: 'It\'s been 25 days since your last contact with Coach Smith at Dallas Baptist University. Consider a short follow-up email or call.',
  ...
  missingVideo: {
    ...
    urgency: 'medium',
    message: 'Consider uploading your first highlight video to share with coaches. 3-5 minutes is plenty.',
  ...
  eventFollowUp: {
    ...
    urgency: 'medium',
    message: 'You attended Texas Scout Showcase on Dec 15. Log a recap interaction to update your coach list.',
    action_type: 'log_interaction',
    related_school_id: null,
    related_task_id: null,
    dismissed: false,
  ...
  portfolioHealth: {
    ...
    urgency: 'high',
    message: 'Your current list has mostly reach schools. Consider adding match and safety options to ensure you have realistic opportunities.',
  ...
  videoLinkBroken: {
    ...
    urgency: 'high',
    message: 'Your highlight video link is no longer accessible. Update it before your next coach email.',
  ...
  eligibilityReminder: {
    ...
    urgency: 'high',
    message: 'You haven\'t registered with the NCAA Eligibility Center yet. Register this week to avoid delays.',
...
export const lateJoinerAssessment = {
  ...
  sampleResults: {
    ...
    answers: {
      'assessment-video': { answer: true, details: 'Created 4-minute highlight on Hudl' },
      'assessment-contact': { answer: true, details: 'Emailed about 8 coaches' },
      'assessment-list': { answer: true, details: 'List of 15 schools, mostly D1' },
      'assessment-eligibility': { answer: false, details: null },
      'assessment-visits': { answer: false, details: null },
      'assessment-tests': { answer: true, details: 'ACT 26, not sent to eligibility center' },
    },
    tasks_to_mark_complete: ['task-10-r1', 'task-10-r5', 'task-10-r3', 'task-11-a3'],
    tasks_to_prioritize: ['task-11-a1', 'task-11-r3', 'task-11-r4'],
    suggested_phase: 'junior',
    recovery_needed: true,
    recovery_focus: 'Expand school list with realistic options, register for eligibility',
  },
}
  ...
  parentSpecificMessages: [
    {
      phase: 'junior',
      division: 'DI',
      message: 'D1 baseball programs typically fill most roster spots by end of junior year. Early signing period is in November.',
    },
    {
      phase: 'junior',
      division: 'DII',
      message: 'D2 programs often have more flexibility in timing. Most athletes here receive partial scholarships averaging 25-50% of costs.',
    },
    {
      phase: 'junior',
      division: 'DIII',
      message: 'D3 programs don\'t offer athletic scholarships, but strong academic aid is common. Official visits can begin January 1 of junior year.',
    },
    {
      context: 'silence',
      message: 'Silence from coaches is normal at this stage. Lack of phone calls by January of senior year would be more concerning.',
    },
  ],
}
  ...
  baseball: {
    ...
    contactPeriods: {
      DI: {
        ...
        notes: 'Coaches can contact athletes starting June 15 after sophomore year',
      },
      DII: {
...
export const statusScoreTestCases = {
  ...
  onTrack: {
    input: {
      ...
      interactionFrequencyScore: 0.70,
      coachInterestScore: 0.80,
      academicStandingScore: 0.90,
    },
    expected: {
  ...
  slightlyBehind: {
    input: {
      ...
      interactionFrequencyScore: 0.50,
      coachInterestScore: 0.55,
      academicStandingScore: 0.70,
    },
    expected: {
  ...
  atRisk: {
    input: {
      ...
      interactionFrequencyScore: 0.20,
      coachInterestScore: 0.25,
      academicStandingScore: 0.40,
    },
    expected: {
  ...
  thresholdBoundary50: {
    input: {
      ...
      interactionFrequencyScore: 0.50,
      coachInterestScore: 0.50,
      academicStandingScore: 0.50,
    },
    expected: {
      score: 50,
...
export const portfolioHealthTestCases = {
  ...
  allReaches: {
    ...
    expected: {
      ...
      safeties: 0,
      unlikelies: 2,
      warnings: ['No match schools', 'No safety schools', 'Portfolio heavily weighted toward reaches'],
      status: 'at_risk',
    },
  },
