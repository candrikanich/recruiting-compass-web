  ...
  describe("Contact Information", () => {
    it("should display email with mailto link", () => {
      ...
      const emailLink = wrapper.find(
        'a[href="mailto:john.smith@university.edu"]',
      );
    ...
    it("should display Twitter handle with link", () => {
      ...
      const twitterLink = wrapper.find(
        'a[href="https://twitter.com/coachsmith"]',
      );
    ...
    it("should display Instagram handle with link", () => {
      ...
      const instagramLink = wrapper.find(
        'a[href="https://instagram.com/coachsmith"]',
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle long email addresses", () => {
      ...
      expect(wrapper.text()).toContain(
        "christopher.vanderbilt.johnson@university.edu",
      );
    });
