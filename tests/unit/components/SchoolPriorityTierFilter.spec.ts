...
describe("SchoolPriorityTierFilter", () => {
  it("should render all tier buttons", () => {
    ...
    expect(wrapper.find('[data-testid="priority-filter-A"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="priority-filter-B"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="priority-filter-C"]').exists()).toBe(true)
  })
  ...
  it("should emit null when clear is clicked", async () => {
    ...
    await wrapper.find('[data-testid="priority-filter-clear"]').trigger("click")
  ...
  it("should respond to prop changes", async () => {
    ...
    expect(
      wrapper.find('[data-testid="priority-filter-clear"]').exists(),
    ).toBe(false)
    ...
    expect(wrapper.find('[data-testid="priority-filter-B"]').classes()).toContain(
      "bg-amber-100",
    )
  })
