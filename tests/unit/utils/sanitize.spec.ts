...
describe("Sanitization utilities", () => {
  describe("sanitizeHtml", () => {
    ...
    describe("Edge cases", () => {
      ...
      it("should handle mixed safe and unsafe content", () => {
        const input =
          '<p>Safe <strong>text</strong></p><script>alert("bad")</script>';
        const result = sanitizeHtml(input);
    ...
    describe("Real-world examples", () => {
      it("should sanitize user-generated school notes", () => {
        const userNote =
          '<p>Great program with <strong>strong</strong> academics</p><script>alert("hack")</script>';
  ...
  describe("sanitizeUrl", () => {
    ...
    describe("Real-world examples", () => {
      ...
      it("should reject injected javascript", () => {
        const injected =
          'javascript:void(0);window.location="http://attacker.com"';
  ...
  describe("sanitizeObject", () => {
    ...
    it("should sanitize array fields", () => {
      const obj = {
        tags: ["<strong>Valid</strong>", '<script>alert("xss")</script>'],
      };
  ...
  describe("Integration: Sanitization workflow", () => {
    it("should sanitize user-submitted school data", () => {
      ...
      const htmlSanitized = sanitizeObject(userInput, ["name", "notes"]);
