...
describe("utils/fitScoreCalculation", () => {
  ...
  describe("calculateAthleticFit", () => {
    ...
    it("should award less points for position mismatch", () => {
      ...
      // SS vs C is complete mismatch, should get minimal points (3) + other factors = 31
  ...
  describe("calculatePersonalFit", () => {
    ...
    it("should award points for in-state preference", () => {
      const inState = calculatePersonalFit(
        "CA",
        "CA",
        "medium",
        15000,
      ...
      const outOfState = calculatePersonalFit(
        "CA",
        "TX",
        "medium",
        15000,
    ...
    it("should award points for priority school", () => {
      const priority = calculatePersonalFit(
        "CA",
        "CA",
        "medium",
        15000,
    ...
    it("should award points for major strength", () => {
      const strong = calculatePersonalFit(
        "CA",
        "CA",
        "medium",
        15000,
      ...
      const weak = calculatePersonalFit(
        "CA",
        "CA",
        "medium",
        15000,
