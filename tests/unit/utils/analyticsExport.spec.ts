...
describe('Analytics Export Utils', () => {
  ...
  describe('chartToImage', () => {
    ...
    it('handles null canvas gracefully', async () => {
      await expect(chartToImage(null as any)).rejects.toThrow('Chart element is null or undefined')
    })
  })
  ...
  describe('generateAnalyticsReport', () => {
    it('generates printable HTML', async () => {
      ...
      const result = await generateAnalyticsReport(title, [], summaryHTML, dateRange)
    ...
    it('formats as HTML', async () => {
      ...
      expect(result.trim().startsWith('<html')).toBe(true) ||
        expect(result.trim().startsWith('<!DOCTYPE')).toBe(true)
    })
    ...
    it('includes summary HTML', async () => {
      ...
      const result = await generateAnalyticsReport('Report', [], summaryHTML, dateRange)
