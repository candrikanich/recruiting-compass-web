...
const mockValidationState = {
  shouldFail: false,
  failMessage: "Password does not meet requirements",
};
  ...
  resetPasswordSchema: {
    safeParse: vi.fn(() => {
      ...
      return {
        success: true,
        data: {
          password: mockBodyState.password,
          confirmPassword: mockBodyState.password,
        },
      };
    }),
  },
...
const { default: handler } =
  await import("~/server/api/auth/confirm-password-reset.post");
