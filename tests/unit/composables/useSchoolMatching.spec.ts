...
import { createMockSchool, createEliteSchool, createMidTierSchool, createAccessibleSchool, createD3School, createMockSchoolPreference, createNortheastSchools, createSoutheastSchools, createSmallSchool, createLargeSchool, createVeryLargeSchool } from '~/tests/fixtures/schools.fixture'
...
describe('useSchoolMatching', () => {
  ...
  describe('calculateMatchScore', () => {
    ...
    it('should achieve 100% score when all preferences match', () => {
      mockSchoolPreferences.preferences = [
        createMockSchoolPreference({ type: 'division', value: ['D1'], priority: 1 }),
        createMockSchoolPreference({ type: 'conference_type', value: ['Power 4'], priority: 2 }),
      ]
    ...
    it('should calculate weighted score based on priority', () => {
      mockSchoolPreferences.preferences = [
        createMockSchoolPreference({ type: 'division', value: ['D1'], priority: 1, is_dealbreaker: false }), // weight=10, match
        createMockSchoolPreference({ type: 'division', value: ['D2'], priority: 2, is_dealbreaker: false }), // weight=9, miss
        createMockSchoolPreference({ type: 'conference_type', value: ['Power 4'], priority: 3, is_dealbreaker: false }), // weight=8, match
      ]
    ...
    it('should prioritize dealbreakers in result', () => {
      ...
      const school = createMockSchool({ division: 'D3', conference: 'Independent' })
      const { calculateMatchScore } = useSchoolMatching()
      const result = calculateMatchScore(school)
  ...
  describe('evaluatePreference', () => {
    describe('Division matching', () => {
      it('should match single division preference', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'division', value: ['D1'] })
      ...
      it('should match multiple division preferences', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'division', value: ['D1', 'D2', 'D3'] })
    ...
    describe('Conference Type matching', () => {
      it('should identify Power 4 conferences', () => {
        ...
        power4Conferences.forEach((conf) => {
          ...
          const pref = createMockSchoolPreference({ type: 'conference_type', value: ['Power 4'] })
          expect(evaluatePreference(school, pref)).toBe(true)
        })
      })

      it('should identify Group of 5 conferences', () => {
        const group5Conferences = ['AAC', 'Mountain West', 'Sun Belt', 'MAC', 'Conference USA']

        const { evaluatePreference } = useSchoolMatching()

        group5Conferences.forEach((conf) => {
          const school = createMockSchool({ conference: conf })
          const pref = createMockSchoolPreference({ type: 'conference_type', value: ['Group of 5'] })
          expect(evaluatePreference(school, pref)).toBe(true)
        })
      })
      ...
      it('should identify Mid-Major conferences', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'conference_type', value: ['Mid-Major'] })
    ...
    describe('Academic rating matching', () => {
      it('should evaluate elite schools (admission_rate < 15%)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'min_academic_rating', value: 5 })
      ...
      it('should evaluate mid-tier schools (admission_rate 30-50%)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'min_academic_rating', value: 3 })
      ...
      it('should fail when minimum rating not met', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'min_academic_rating', value: 4 })
    ...
    describe('School size matching', () => {
      it('should match small schools (< 5000)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'school_size', value: 'small' })
      ...
      it('should match medium schools (5000-15000)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'school_size', value: 'medium' })
      ...
      it('should match large schools (15000-30000)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'school_size', value: 'large' })
      ...
      it('should match very large schools (30000+)', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'school_size', value: 'very_large' })
    ...
    describe('Region matching', () => {
      it('should match Northeast schools', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'preferred_regions', value: ['northeast'] })
      ...
      it('should match Southeast schools', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'preferred_regions', value: ['southeast'] })
      ...
      it('should not match when region not in preferences', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'preferred_regions', value: ['southwest'] })
    ...
    describe('State matching', () => {
      it('should match by state abbreviation', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'preferred_states', value: ['MA'] })
      ...
      it('should handle multiple state preferences', () => {
        ...
        const pref = createMockSchoolPreference({ type: 'preferred_states', value: ['CA', 'TX', 'FL'] })
      ...
      it('should return false for non-matching state', () => {
        const school = createMockSchool({ location: 'Boston, MA' })
        const pref = createMockSchoolPreference({ type: 'preferred_states', value: ['CA'] })
  ...
  describe('getAcademicRating', () => {
    ...
    it('should return 2 for good schools (50-70%)', () => {
      const school = createMockSchool({
        academic_info: { admission_rate: 0.60 },
      })
      const { getAcademicRating } = useSchoolMatching()
    ...
    it('should handle boundary cases', () => {
      ...
      expect(getAcademicRating(createMockSchool({ academic_info: { admission_rate: 0.1499 } }))).toBe(5)
      expect(getAcademicRating(createMockSchool({ academic_info: { admission_rate: 0.1500 } }))).toBe(4)
      expect(getAcademicRating(createMockSchool({ academic_info: { admission_rate: 0.2999 } }))).toBe(4)
      expect(getAcademicRating(createMockSchool({ academic_info: { admission_rate: 0.3000 } }))).toBe(3)
    })
  })
  ...
  describe('Edge cases', () => {
    ...
    it('should handle missing home location for distance evaluation', () => {
      ...
      const school = createMockSchool()
      const pref = createMockSchoolPreference({ type: 'max_distance_miles', value: 300 })
