...
describe("Error Handling - Critical Scenarios", () => {
  ...
  describe("Validation Errors", () => {
    ...
    it("should validate required fields", async () => {
      ...
      expect(() =>
        validateRequired(incompleteData, ["name", "location", "division"]),
      ).toThrow();
    });
  });
  ...
  describe("File Upload Errors", () => {
    it("should reject files exceeding size limit", async () => {
      ...
      expect(() => validateFileSize(largeFileSize, maxSize)).toThrow(
        "exceeds limit",
      );
    });
  ...
  describe("Database Errors", () => {
    it("should handle database connection failure", async () => {
      mockQuery.order.mockRejectedValue(
  ...
  describe("Business Logic Errors", () => {
    it("should prevent invalid school status transition", async () => {
      ...
      expect(() => transitionStatus("committed", "researching")).toThrow(
        "Cannot transition",
      );
    });
  ...
  describe("Error Recovery", () => {
    ...
    it("should provide user-friendly error messages", async () => {
      ...
      expect(getUserMessage("Network timeout")).toContain(
