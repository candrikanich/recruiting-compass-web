...
describe('useCoachAvailability', () => {
  ...
  describe('updateCoachAvailability', () => {
    it('should update coach availability', async () => {
      ...
      const availability = useCoachAvailability()
      const result = await availability.updateCoachAvailability('coach-1', newAvailability)

      expect(result).toBe(true)
      expect(mockUpdateCoach).toHaveBeenCalledWith('coach-1', { availability: newAvailability })
    })

    it('should return false if coach not found', async () => {
      const availability = useCoachAvailability()
      const result = await availability.updateCoachAvailability('non-existent', {} as CoachAvailability)
    ...
    it('should handle update error gracefully', async () => {
      ...
      const availability = useCoachAvailability()
      const result = await availability.updateCoachAvailability('coach-1', {} as CoachAvailability)
  ...
  describe('setDayAvailability', () => {
    it('should set availability for a specific day', async () => {
      const dayAvailability: DayAvailability = { available: true, start_time: '08:00', end_time: '18:00' }

      const availability = useCoachAvailability()
      const result = await availability.setDayAvailability('coach-1', 'monday', dayAvailability)
    ...
    it('should return false for invalid day', async () => {
      ...
      const availability = useCoachAvailability()
      const result = await availability.setDayAvailability('coach-1', 'invalid-day', dayAvailability)
  ...
  describe('toggleDayAvailability', () => {
    it('should toggle day availability on', async () => {
      ...
      const availability = useCoachAvailability()
      const result = await availability.toggleDayAvailability('coach-1', 'monday')
    ...
    it('should handle invalid day', async () => {
      const availability = useCoachAvailability()
      const result = await availability.toggleDayAvailability('coach-1', 'invalid-day')
  ...
  describe('addBlackoutDate', () => {
    it('should add a blackout date', async () => {
      const availability = useCoachAvailability()
      const result = await availability.addBlackoutDate('coach-1', '2024-12-25')
  ...
  describe('removeBlackoutDate', () => {
    it('should remove a blackout date', async () => {
      ...
      const availability = useCoachAvailability()
      const result = await availability.removeBlackoutDate('coach-1', '2024-12-25')
    ...
    it('should handle removing non-existent blackout date', async () => {
      const availability = useCoachAvailability()
      const result = await availability.removeBlackoutDate('coach-1', '2024-01-01')
