...
describe('useCoachAnalytics', () => {
  ...
  describe('calculateCoachMetrics', () => {
    it('should calculate metrics for a coach', () => {
      const now = new Date()
      mockInteractions.value = [
        createMockInteraction({ id: 'i1', direction: 'outbound', occurred_at: new Date(now.getTime() - 10 * 60 * 60 * 1000).toISOString() }),
        createMockInteraction({ id: 'i2', direction: 'inbound', occurred_at: new Date(now.getTime() - 9 * 60 * 60 * 1000).toISOString() }),
        createMockInteraction({ id: 'i3', direction: 'outbound', occurred_at: new Date(now.getTime() - 5 * 60 * 60 * 1000).toISOString() }),
        createMockInteraction({ id: 'i4', direction: 'inbound', occurred_at: new Date(now.getTime() - 4 * 60 * 60 * 1000).toISOString() }),
      ]
    ...
    it('should identify preferred communication method', () => {
      mockInteractions.value = [
        createMockInteraction({ id: 'i1', direction: 'inbound', type: 'email' }),
        createMockInteraction({ id: 'i2', direction: 'inbound', type: 'email' }),
        createMockInteraction({ id: 'i3', direction: 'inbound', type: 'phone_call' }),
      ]
    ...
    it('should calculate average response time', () => {
      ...
      mockInteractions.value = [
        createMockInteraction({
          id: 'i1',
          direction: 'outbound',
          occurred_at: new Date(now.getTime() - 48 * 60 * 60 * 1000).toISOString() // 48 hours ago
        }),
        createMockInteraction({
          id: 'i2',
          direction: 'inbound',
          occurred_at: new Date(now.getTime() - 47 * 60 * 60 * 1000).toISOString() // 47 hours ago (1 hour response)
        }),
      ]
    ...
    it('should calculate days since contact', () => {
      ...
      mockInteractions.value = [
        createMockInteraction({ id: 'i1', occurred_at: tenDaysAgo.toISOString() }),
      ]
    ...
    it('should generate trend data over time', () => {
      ...
      mockInteractions.value = [
        ...
        createMockInteraction({
          id: 'i2',
          direction: 'inbound',
          occurred_at: new Date(now.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString()
        }),
        createMockInteraction({
          id: 'i3',
          direction: 'outbound',
      ...
      expect(trendData.every(d => typeof d.score === 'number' && d.date)).toBe(true)
    })

    it('should return empty array if no interactions', () => {
      const analytics = useCoachAnalytics()
      const trendData = analytics.calculateTrendData('coach-no-interactions', 30)
  ...
  describe('compareWithSchoolAverage', () => {
    it('should compare coach with school average', () => {
      ...
      mockInteractions.value = [
        ...
        createMockInteraction({ id: 'i2', coach_id: 'coach-1', direction: 'inbound' }),
        createMockInteraction({ id: 'i3', coach_id: 'coach-2', direction: 'outbound' }),
        createMockInteraction({ id: 'i4', coach_id: 'coach-3', direction: 'outbound' }),
      ]

      const analytics = useCoachAnalytics()
      const comparison = analytics.compareWithSchoolAverage('coach-1', 'school-1')
    ...
    it('should return null if no school provided', () => {
      const analytics = useCoachAnalytics()
      const comparison = analytics.compareWithSchoolAverage('coach-1', undefined)
    ...
    it('should calculate coach rank within school', () => {
      mockCoaches.value = [
        createMockCoach({ id: 'coach-1', school_id: 'school-1', responsiveness_score: 50 }),
        createMockCoach({ id: 'coach-2', school_id: 'school-1', responsiveness_score: 80 }),
        createMockCoach({ id: 'coach-3', school_id: 'school-1', responsiveness_score: 70 }),
      ]

      mockInteractions.value = [
        createMockInteraction({ coach_id: 'coach-1', direction: 'outbound' }),
        createMockInteraction({ id: 'i2', coach_id: 'coach-2', direction: 'outbound' }),
        createMockInteraction({ id: 'i3', coach_id: 'coach-2', direction: 'inbound' }),
        createMockInteraction({ id: 'i4', coach_id: 'coach-3', direction: 'outbound' }),
      ]
  ...
  describe('generateInsights', () => {
    ...
    it('should provide response time insights for slow responder', () => {
      ...
      mockInteractions.value = [
        createMockInteraction({
          id: 'i1',
          direction: 'outbound',
          occurred_at: new Date(now.getTime() - 100 * 60 * 60 * 1000).toISOString()
        }),
        createMockInteraction({
          id: 'i2',
          direction: 'inbound',
          occurred_at: new Date(now.getTime() - 50 * 60 * 60 * 1000).toISOString()
        }),
      ]
    ...
    it('should identify preferred communication method', () => {
      mockInteractions.value = [
        createMockInteraction({ id: 'i1', direction: 'inbound', type: 'phone_call' }),
        createMockInteraction({ id: 'i2', direction: 'inbound', type: 'phone_call' }),
        createMockInteraction({ id: 'i3', direction: 'inbound', type: 'email' }),
      ]
    ...
    it('should return empty array if no insights apply', () => {
      ...
      mockInteractions.value = [
        ...
        createMockInteraction({
          id: 'i2',
          direction: 'inbound',
          occurred_at: new Date(recentDate.getTime() + 1 * 60 * 60 * 1000).toISOString()
        }),
      ]
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle interactions with no occurred_at', () => {
      mockInteractions.value = [
        createMockInteraction({ id: 'i1', direction: 'outbound', occurred_at: undefined as any }),
        createMockInteraction({ id: 'i2', direction: 'inbound', occurred_at: new Date().toISOString() }),
      ]
