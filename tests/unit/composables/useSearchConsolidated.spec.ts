...
describe("useSearchConsolidated", () => {
  ...
  describe("Filtering", () => {
    ...
    it("should remove filter and restore results", async () => {
      ...
      vi.mocked(composable as any).removeFilter = vi.fn().mockReturnValue({
        results: allResults,
        activeFilters: [],
      });
    ...
    it("should reset all filters", async () => {
      ...
      vi.mocked(composable as any).resetFilters = vi.fn().mockReturnValue({
        results: allResults,
        activeFilters: [],
      });
  ...
  describe("Result Formatting", () => {
    ...
    it("should highlight search matches in results", async () => {
      const results = createMockSearchResults(2, {
        excerpt: "This contains test keyword",
      });
    ...
    it("should paginate search results", async () => {
      ...
      vi.mocked(composable as any).paginateResults = vi.fn().mockReturnValue({
  ...
  describe("Error Handling", () => {
    ...
    it("should handle search API errors gracefully", async () => {
      ...
      await expect(composable.performSearch("test")).rejects.toThrow(
        "Search service",
      );
    });
  ...
  describe("State Management", () => {
    ...
    it("should track active filters in state", async () => {
      ...
      expect((composable as any).setActiveFilters).toHaveBeenCalledWith(
        filters,
      );
    });
  });
