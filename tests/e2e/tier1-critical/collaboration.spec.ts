...
test.describe('Tier 1: Family Collaboration - Critical Flows', () => {
  ...
  test('should change collaborator role', async ({ page }) => {
    ...
    await collaborationPage.changeCollaboratorRole(testUsers.collaborator.displayName, 'Admin')
  ...
  test('should remove collaborator', async ({ page }) => {
    ...
    // Remove
    await collaborationPage.removeCollaborator(testUsers.collaborator.displayName)

    await collaborationPage.expectNotCollaborator(testUsers.collaborator.displayName)
  })
