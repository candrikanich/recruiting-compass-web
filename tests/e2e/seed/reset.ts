...
async function resetDatabase() {
  ...
  try {
    ...
    await supabase.from('preference_history').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    await supabase.from('user_preferences').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    await supabase.from('athlete_tasks').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    ...
    await supabase.from('account_links').delete().neq('id', '00000000-0000-0000-0000-000000000000');
