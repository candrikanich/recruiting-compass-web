...
GET `/api/schools/recommendations` ranks without these tables; POST dismiss requires `school_recommendation_dismissals` (now live). Recorded in `schema_migrations` as repo filename `20260912000000`. PR #549 (`cursor/school-recommendations-92b1` → develop).
