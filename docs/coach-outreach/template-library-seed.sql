-- ============================================================================
-- The Recruiting Compass — Coach Outreach Template Library
-- Complete variable registry + template seed data
-- Sport-agnostic. Review before applying; nothing here is destructive.
-- ============================================================================

-- ----------------------------------------------------------------------------
-- SECTION 1 — VARIABLE REGISTRY
-- Drives the compose-screen picker. Adding a variable = a seed row, not a deploy.
--
-- source_type:
--   column    -> auto-filled from a stored column
--   computed  -> assembled by the resolver (metrics block, schedules, salutation)
--   authored  -> the athlete writes it at compose time; can gate the send button
--   system    -> generated at render (dates, counters)
-- ----------------------------------------------------------------------------
...
-- Player identity -------------------------------------------------------------
('playerName',        'Full name',          'Athlete''s full name',                         'player','column','athletes.full_name',        false,'Jordan Ellis',        10),
('playerFirstName',   'First name',         'Athlete''s first name',                        'player','column','athletes.first_name',       false,'Jordan',              11),
('gradYear',          'Grad year',          'Expected high school graduation year',         'player','column','athletes.grad_year',        false,'2028',                12),
('sport',             'Sport',              'Athlete''s sport',                             'player','column','athletes.sport',            false,'Baseball',            13),
('position',          'Position / event',   'Position, event, stroke, or weight class',     'player','column','athletes.position',         false,'Shortstop',           14),
('positionSecondary', 'Secondary position', 'Second position or event they can play',       'player','column','athletes.position_secondary',false,'Second base',        15),
('jerseyNumber',      'Jersey number',      'Number coaches should look for',               'player','column','athletes.jersey_number',    false,'14',                  16),
('height',            'Height',             'Formatted height',                             'player','computed',null,                      false,'6''2"',               17),
('weight',            'Weight',             'Weight in pounds',                             'player','computed',null,                      false,'185 lbs',             18),
('dominantSide',      'Dominant side',      'Bats/throws, footedness, stroke side, stance', 'player','column','athletes.dominant_side',    false,'R/R',                 19),
('highSchool',        'High school',        'Current high school',                          'player','column','athletes.high_school',      false,'Olmsted Falls HS',    20),
('clubTeam',          'Club team',          'Club, travel, AAU, or academy team',           'player','column','athletes.club_team',        false,'Ohio Elite 17U',      21),
('hometownCity',      'Hometown city',      'City coaches recruit from',                    'player','column','athletes.hometown_city',    false,'Olmsted Falls',       22),
('hometownState',     'Hometown state',     'State abbreviation',                           'player','column','athletes.hometown_state',   false,'OH',                  23),

-- Academics -------------------------------------------------------------------
('gpaUnweighted',     'Unweighted GPA',     'Unweighted GPA — the only one coaches use',    'academics','column','athletes.gpa_unweighted',false,'3.68',                30),
('testLabel',         'Test name',          'ACT or SAT',                                   'academics','column','athletes.test_label',    false,'ACT',                 31),
('testScore',         'Test score',         'Score for the named test',                     'academics','column','athletes.test_score',    false,'29',                  32),
('classRank',         'Class rank',         'Class rank if it helps',                       'academics','column','athletes.class_rank',    false,'22 of 310',           33),
('intendedMajor',     'Intended major',     'Field the athlete plans to study',             'academics','column','athletes.intended_major',false,'Mechanical Engineering',34),
('academicHonors',    'Academic honors',    'Honor roll, AP coursework, academic awards',   'academics','column','athletes.academic_honors',false,'AP Scholar, 4 AP courses',35),
('ncaaId',            'NCAA ID',            'NCAA Eligibility Center ID number',            'academics','column','athletes.ncaa_id',       false,'2109887654',          36),
('transcriptLink',    'Transcript link',    'Link to an unofficial transcript',             'academics','column','athletes.transcript_link',false,'https://…',          37),

-- Athletic proof ---------------------------------------------------------------
('metrics',           'Metrics block',      'Top metrics with source and date, max 4',      'metrics','computed',null,                     false,'- 60-yard dash: 6.71 (Perfect Game, Jun 2026)',40),
('carryingTool',      'Carrying tool',      'The single best number — leads the subject line','metrics','computed',null,                   false,'6.71 60-yard dash',   41),
('metricsAsOf',       'Metrics as of',      'Date of the most recent metric',               'metrics','computed',null,                     false,'June 2026',           42),
('videoLink',         'Film link',          'Highlight or skills video — never an attachment','metrics','column','athletes.video_link',    false,'https://…',           43),
('profileLink',       'Profile link',       'Full Recruiting Compass profile',              'metrics','column','athletes.profile_link',    false,'https://…',           44),
('seasonStatLine',    'Season stat line',   'Production line from the most recent season',  'metrics','column','athletes.season_stat_line',false,'.412 / 8 2B / 21 SB', 45),
('awards',            'Awards',             'Individual honors and selections',             'metrics','column','athletes.awards',          false,'First Team All-Conference',46),
('teamAccomplishment','Team accomplishment','Team result worth mentioning',                 'metrics','column','athletes.team_accomplishment',false,'District runner-up',47),

-- Contacts ---------------------------------------------------------------------
('playerPhone',       'Athlete phone',      'Athlete''s own number',                        'contacts','column','athletes.player_phone',   false,'440-555-0134',        50),
('playerEmail',       'Athlete email',      'Athlete''s own email',                         'contacts','column','athletes.player_email',   false,'jordan.ellis28@…',    51),
('hsCoachName',       'HS coach name',      'High school head coach',                       'contacts','column','athletes.hs_coach_name',  false,'Dave Reilly',         52),
('hsCoachPhone',      'HS coach phone',     'High school coach phone',                      'contacts','column','athletes.hs_coach_phone', false,'440-555-0177',        53),
('hsCoachEmail',      'HS coach email',     'High school coach email',                      'contacts','column','athletes.hs_coach_email', false,'dreilly@…',           54),
('clubCoachName',     'Club coach name',    'Club or travel coach',                         'contacts','column','athletes.club_coach_name',false,'Marcus Webb',         55),
('clubCoachPhone',    'Club coach phone',   'Club coach phone',                             'contacts','column','athletes.club_coach_phone',false,'216-555-0192',       56),
('clubCoachEmail',    'Club coach email',   'Club coach email',                             'contacts','column','athletes.club_coach_email',false,'mwebb@…',            57),

-- Program ----------------------------------------------------------------------
('coachFirstName',    'Coach first name',   'Coach''s first name',                          'program','column','coaches.first_name',       false,'Ryan',                60),
('coachLastName',     'Coach last name',    'Coach''s last name',                           'program','column','coaches.last_name',        false,'Delgado',             61),
('coachSalutation',   'Coach salutation',   'How to address them — defaults to Coach + last name','program','computed',null,               false,'Coach Delgado',       62),
('coachTitle',        'Coach title',        'Head coach, recruiting coordinator, position coach','program','column','coaches.title',       false,'Recruiting Coordinator',63),
('schoolName',        'School name',        'Full university name',                         'program','column','programs.school_name',     false,'State University',    64),
('schoolShortName',   'School short name',  'How people actually refer to the school',      'program','column','programs.short_name',      false,'State',               65),
('programMascot',     'Mascot',             'Team nickname',                                'program','column','programs.mascot',           false,'Falcons',             66),
('division',          'Division',           'NCAA division or association level',           'program','column','programs.division',        false,'NCAA Division II',    67),
('conference',        'Conference',         'Athletic conference',                          'program','column','programs.conference',       false,'GMAC',                68),
...
('eventDates',        'Event dates',        'Formatted date range',                         'event','computed',null,                       false,'July 18–19',          81),
('eventLocation',     'Event location',     'City and venue',                               'event','column','athlete_events.location',    false,'Grand Park, Westfield IN',82),
('eventSchedule',     'Event schedule',     'Rendered rows: time, opponent, venue detail',  'event','computed',null,                       false,'- Sat Jul 18, 9:00 AM vs Northeast Elite — Field 4',83),
('teamAtEvent',       'Team at event',      'Which team they''re playing for there',        'event','column','athlete_events.team_name',   false,'Ohio Elite 17U',      84),
('roleNote',          'Role note',          'When they pitch, swim, or their expected role','event','column','athlete_events.role_note',   false,'Scheduled to pitch Saturday AM',85),
('rosterLink',        'Roster link',        'Event roster or heat sheet',                   'event','column','athlete_events.roster_link', false,'https://…',           86),
('nextEventName',     'Next event',         'The following event on the calendar',          'event','computed',null,                       false,'Buckeye Elite Classic',87),
('nextEventDates',    'Next event dates',   'Dates of the next event',                      'event','computed',null,                       false,'August 8–10',         88),
('visitDate',         'Visit date',         'Date of a camp or campus visit',               'event','column','athlete_events.starts_on',   false,'July 22',             89),
...
('contactWindowDate', 'Contact date',       'When coaches at this level can respond',       'system','computed',null,                   false,'June 15, 2027',       122),
('daysSinceContact',  'Days since contact', 'Days since the last message to this program',  'system','computed',null,                   false,'11',                  123)
...
-- SECTION 2 — TEMPLATES
--
-- stage:   intro | update | event | post_event | thanks | nudge | reply
--          | visit | status | decision | social
-- window:  'pre' = usable before the coach can legally reply
--          'post' = assumes two-way conversation is allowed
--          'any'
-- ----------------------------------------------------------------------------

insert into message_template
  (slug, channel, stage, contact_window, title, send_timing_note, length_target,
   subject_template, body_template, required_variables, sort_order)
values
...
{{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["programNote","referrerName"]'::jsonb, 30),
...
Thank you,
{{playerName}} | {{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["updateHook","filmDescription"]'::jsonb, 60),
...
Thank you,
{{playerName}} | {{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["roleChange","updateHook"]'::jsonb, 90),
...
Thank you,
{{playerName}} | {{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["injuryNote","returnTimeline"]'::jsonb, 100),
...
Thanks again,
{{playerName}} | {{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["answerTheirQuestion","questionBack"]'::jsonb, 170),
...
Thank you,
{{playerName}} | {{gradYear}} | {{position}} | {{playerPhone}}$b$,
 '["updateHook"]'::jsonb, 240),

-- === TEXT ===================================================================
-- Gate all of these behind an explicit "the coach texted me first, or said it's OK"
-- toggle. A coach handing over a cell number signals real interest; an uninvited
-- text spends it. Every text signs off with a full name — coaches don't have the
-- athlete saved.

('text-first','text','intro','post',
 'First text after permission',
 'Only after the coach texts first or says it''s fine.', '2 lines', null,
 $b${{coachSalutation}} — thanks for the OK to text. {{updateHook}}
Let me know if a call works better this week.
— {{playerName}}, {{gradYear}} {{position}}$b$,
 '["updateHook"]'::jsonb, 300),

('text-event-day','text','event','post',
 'Event day heads-up',
 'Morning of, or the night before.', '2 lines', null,
...
('text-post-call','text','thanks','post',
 'After a call',
 'Same day. Follow with an email to the full staff.', '2 lines', null,
 $b${{coachSalutation}} — thanks for the call today. {{specificTakeaway}} {{schoolShortName}} is a place I could see myself. Talk soon.
— {{playerName}}, {{gradYear}} {{position}}$b$,
 '["specificTakeaway"]'::jsonb, 320),

('text-arriving','text','visit','post',
 'Arriving on campus',
 'On arrival, if you''ve already been texting.', '1 line', null,
 $b${{coachSalutation}} — just got to campus, looking forward to today.
— {{playerName}}, {{gradYear}}$b$,
 '[]'::jsonb, 330),

('text-update','text','update','post',
 'Quick update',
 'Sparingly. Email is still the default channel for updates.', '2 lines', null,
 $b${{coachSalutation}} — quick one: {{updateHook}}. New film if you want it: {{videoLink}}
— {{playerName}}, {{gradYear}} {{position}}$b$,
 '["updateHook"]'::jsonb, 340),

('text-thanks-visit','text','thanks','post',
 'After a visit',
 'Same day, in addition to the email — not instead of it.', '2 lines', null,
 $b${{coachSalutation}} — thank you for today. {{specificTakeaway}} Really appreciated the time.
— {{playerName}}, {{gradYear}} {{position}}$b$,
 '["specificTakeaway"]'::jsonb, 350),

('text-schedule-reply','text','reply','post',
 'Answering a coach''s question by text',
 'Within a few hours. A reply the same day is plenty.', '2 lines', null,
 $b${{coachSalutation}} — {{answerTheirQuestion}}
— {{playerName}}, {{gradYear}} {{position}}$b$,
 '["answerTheirQuestion"]'::jsonb, 360),

-- === SOCIAL =================================================================
-- NCAA rules require coaches to recruit through private channels, so a coach
-- can't engage a public post the way they can an email. These two are the only
-- appropriate public uses. Everything else routes to email.

('social-visit-thanks','social','thanks','any',
 'Public thank-you after a visit',
 'After the visit, and after the private thank-you email.', '1 post', null,
...
('social-commitment','social','decision','any',
 ...
 'After you''ve told every coach who recruited you, privately, first.', '1 post', null,
