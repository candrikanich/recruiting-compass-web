  ...
  <div class="rounded-lg p-6 bg-white shadow-md">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
      <div>
        ...
        <p class="text-sm mt-1 text-slate-600">{{ totalItems }} {{ itemsLabel }}</p>
      </div>
    ...
    <div v-if="hasData && showSummary" class="mt-6 pt-6 border-t border-slate-200">
...
const totalItems = computed(() => props.data.reduce((sum, item) => sum + item.value, 0))
