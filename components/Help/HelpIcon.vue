...
<template>
  <div :class="variantClasses[variant]">
    <TooltipGuide v-if="showTooltip && helpDef" :help-definition="helpDef">
      <button
        class="flex items-center justify-center rounded-full bg-blue-100 text-blue-700 transition-colors hover:bg-blue-200 focus:ring-2 focus:ring-blue-400 focus:ring-offset-1"
