        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6 z-50">
          ...
          <form @submit.prevent="handleSave" class="space-y-4">
            ...
            <div class="bg-gray-50 rounded-lg p-3 space-y-2">
              <p class="text-xs font-semibold text-gray-600 uppercase">Search Details</p>
              <div class="text-sm text-gray-700">
                <p><span class="font-medium">Query:</span> {{ searchQuery }}</p>
                <p><span class="font-medium">Type:</span> {{ getTypeLabel(searchType) }}</p>
                <p v-if="resultsCount > -1"><span class="font-medium">Results:</span> {{ resultsCount }}</p>
              </div>
            </div>
