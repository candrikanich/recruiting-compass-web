...
<template>
  <div>
    ...
    <select
      ...
      class="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 shadow-xs transition-colors focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-500"
      :class="{
