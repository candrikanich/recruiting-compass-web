<template>
  <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
    ...
    <ul
      ...
      class="divide-y divide-slate-200 overflow-hidden rounded-lg border border-slate-200"
    >
        ...
        >
          ...
          <span class="flex shrink-0 items-center gap-2 pl-2">
            <span
              ...
              class="hidden rounded-sm px-2 py-1 text-xs font-semibold sm:inline"
