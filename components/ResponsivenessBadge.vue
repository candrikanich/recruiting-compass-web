<template>
  <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full" :class="badgeClass">
...
const badgeClass = computed(() => {
  if (props.percentage >= 80) return 'bg-brand-emerald-100 text-brand-emerald-700'
  if (props.percentage >= 60) return 'bg-brand-blue-100 text-brand-blue-700'
  if (props.percentage >= 40) return 'bg-brand-orange-100 text-brand-orange-700'
  if (props.percentage >= 20) return 'bg-brand-orange-100 text-brand-orange-700'
