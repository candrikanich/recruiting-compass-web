<template>
  ...
  >
    ...
    <button
      ...
      class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 focus:outline-2 focus:outline-offset-1 focus:outline-blue-600"
    >
    ...
    <button
      ...
      class="ml-2 text-xs text-slate-500 underline hover:text-slate-700 focus:outline-2 focus:outline-offset-1 focus:outline-blue-600"
    >
      Clear all
    </button>
  </div>
