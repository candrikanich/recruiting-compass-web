<template>
  <div class="school-map">
    <div v-if="hasCoordinates" ref="mapContainer" class="h-48 w-full rounded-lg overflow-hidden border border-slate-300"></div>
    <div v-else class="h-48 w-full rounded-lg flex items-center justify-center bg-slate-50 border border-slate-300">
