<template>
  ...
  >
    ...
    <div
      class="mb-4 h-24 rounded-lg flex items-center justify-center bg-slate-100"
    >
    ...
    <div class="flex-1 mb-4">
      <p class="text-xs font-semibold mb-1 text-blue-600">
        {{ getTypeLabel(document.type) }}
      </p>
      <h3 class="text-lg font-bold line-clamp-2 text-slate-900">
        {{ document.title }}
      </h3>
      <p
        v-if="document.description"
        class="text-sm mt-2 line-clamp-2 text-slate-600"
      >
