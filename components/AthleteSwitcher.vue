  ...
  <div v-if="showSwitcher" class="bg-slate-50 border-b border-slate-200 py-3">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center gap-3">
        ...
        <select
          v-model="selectedId"
          class="px-3 py-2 text-sm border border-slate-300 rounded-lg bg-white hover:border-slate-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent cursor-pointer"
          @change="handleSwitch"
        >
          <option
