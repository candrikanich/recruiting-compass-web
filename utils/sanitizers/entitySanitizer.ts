...
export const sanitizeSchoolFields = <T extends SchoolFields>(data: T): T => ({
  ...
  ...(data.coaching_philosophy != null && {
    coaching_philosophy: sanitizeHtml(data.coaching_philosophy),
  }),
  ...(data.coaching_style != null && {
    coaching_style: sanitizeHtml(data.coaching_style),
  }),
  ...(data.recruiting_approach != null && {
    recruiting_approach: sanitizeHtml(data.recruiting_approach),
  }),
  ...(data.communication_style != null && {
    communication_style: sanitizeHtml(data.communication_style),
  }),
  ...(data.success_metrics != null && {
    success_metrics: sanitizeHtml(data.success_metrics),
  }),
});
