...
const VERY_POSITIVE_KEYWORDS = [
  'commit', 'committed', 'signed', 'offer', 'scholarship', 'excited',
  'welcome', 'officially', 'proud', 'congratulations', 'congrats',
  'dream', 'blessed', 'honored', 'thrilled', 'amazing'
]

const POSITIVE_KEYWORDS = [
  'visit', 'visited', 'camp', 'impressed', 'great', 'awesome',
  'looking forward', 'interest', 'interested', 'talented', 'prospect',
  'workout', 'showcase', 'opportunity', 'potential', 'strong',
  'thank', 'thanks', 'grateful', 'love', 'good', 'nice', 'excellent',
  'fantastic', 'outstanding', 'win', 'victory', 'champion'
]

const NEGATIVE_KEYWORDS = [
  'decommit', 'decommitted', 'declined', 'unfortunately', 'injury',
  'injured', 'hurt', 'loss', 'lost', 'disappointed', 'frustrating',
  'cancelled', 'canceled', 'postponed', 'concern', 'worried'
]
 ...
 */
export function getSentimentEmoji(sentiment: Sentiment | null | undefined): string {
  switch (sentiment) {
