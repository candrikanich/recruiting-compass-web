            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
              <div class="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p class="text-lg text-gray-600 mt-2 capitalize">
              ...
              <div class="flex flex-wrap gap-2">
                <span
                  class="inline-block px-3 py-1 text-sm font-semibold rounded-sm bg-blue-100 text-blue-700"
                >
                  {{ schoolName }}
                </span>
              </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
              <div class="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  class="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-semibold rounded-sm hover:bg-blue-200 transition"
                >
