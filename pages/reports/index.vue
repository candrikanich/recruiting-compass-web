    ...
    <div class="bg-white border-b border-slate-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div>
          ...
          <p class="text-slate-600">Generate comprehensive reports and export recruiting data</p>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            <h2 class="text-lg font-semibold text-slate-900 mb-4">Generate Report</h2>
            ...
            <div class="space-y-4">
              ...
              >
                <div v-if="isGenerating" class="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent"></div>
          ...
          <!-- Report Results -->
          <div v-if="currentReport" class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
              <div class="bg-slate-50 rounded-xl p-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-2xl font-bold text-slate-900">{{ currentReport.schools?.total || 0 }}</p>
              ...
              <div class="bg-slate-50 rounded-xl p-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-2xl font-bold text-slate-900">{{ currentReport.coaches?.total || 0 }}</p>
              ...
              <div class="bg-slate-50 rounded-xl p-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-2xl font-bold text-slate-900">{{ currentReport.interactions?.total || 0 }}</p>
              ...
              <div class="bg-slate-50 rounded-xl p-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-2xl font-bold text-slate-900">{{ currentReport.metrics?.total || 0 }}</p>
              ...
              <div class="bg-slate-50 rounded-xl p-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="text-2xl font-bold text-slate-900">{{ currentReport.coaches?.avgResponseRate || 0 }}%</p>
            ...
            <!-- Schools by Status -->
            <div v-if="currentReport.schools?.byStatus" class="pt-6 border-t border-slate-200">
              <h3 class="font-semibold text-slate-900 mb-3">Schools by Status</h3>
              <div class="space-y-2">
                <div
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            ...
            <p class="text-sm text-slate-600 mb-4">
              Generate reports and export data in various formats for sharing with coaches, advisors, or for your records.
            </p>
            <div class="space-y-2">
...
const { currentReport, isGenerating, error, generateReport, exportToCSV } = useReports()
