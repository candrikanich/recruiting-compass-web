          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option v-if="schoolCoaches.length > 0" value="" disabled>
                  ---
                </option>
                <option v-if="schoolCoaches.length > 0" value="other">
                  Other coach (not listed)
                </option>
                <option v-if="schoolCoaches.length > 0" value="add-new">
                  + Add new coach
                </option>
              </select>
            </div>
            ...
            <div>
              ...
              <div class="flex gap-4">
                <label class="flex items-center gap-3 cursor-pointer group">
                  ...
                  />
                  <span
                    class="text-slate-700 group-hover:text-indigo-600 transition-colors"
                    >Outbound (We initiated)</span
                  >
                </label>
                <label class="flex items-center gap-3 cursor-pointer group">
                  <input
            ...
            <div
              v-if="
                ...
                form.sentiment &&
                ['positive', 'very_positive'].includes(form.sentiment)
              "
            ...
            <div>
              ...
              <div
                class="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center bg-slate-50 hover:bg-slate-100 transition-colors"
              >
                <input
                  ref="fileInput"
                  type="file"
    ...
    <Teleport to="body">
      <Transition name="fade">
        ...
        >
          ...
          >
            <div
              class="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white px-6 py-6 rounded-t-2xl"
            >
...
const saveNewCoach = async (coachData: {
  first_name: string;
  last_name: string;
  role: string;
}) => {
