  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Search across schools, coaches, interactions, and performance metrics</p>
      </div>
      ...
      <div class="mb-6">
        ...
        <SearchInput
          ...
          @update:search-type="searchType = $event as 'all' | 'schools' | 'coaches' | 'interactions' | 'metrics'"
          @search="handleSearch"
      ...
      <div v-if="!searchQuery" class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <div v-if="searchQuery" class="space-y-8">
        ...
        <!-- Error State -->
        <div v-else-if="searchError" class="bg-red-50 border border-red-200 rounded-lg p-6">
        ...
        <!-- Schools Results -->
        <div v-if="(searchType === 'all' || searchType === 'schools') && schoolResults.length > 0">
        ...
        <!-- Coaches Results -->
        <div v-if="(searchType === 'all' || searchType === 'coaches') && coachResults.length > 0">
          <SearchResultsSection
            title="Coaches"
        ...
        <div v-if="(searchType === 'all' || searchType === 'interactions') && interactionResults.length > 0">
          <SearchResultsSection
            title="Interactions"
        ...
        <!-- Metrics Results -->
        <div v-if="(searchType === 'all' || searchType === 'metrics') && metricsResults.length > 0">
          <SearchResultsSection
      ...
      <div v-else class="text-center py-12">
        ...
        <p class="mt-2 text-gray-600">Enter a search term above to find schools, coaches, interactions, and metrics</p>
      </div>
    </div>
  </div>
</template>
...
const searchTypes = ['all', 'schools', 'coaches', 'interactions', 'metrics'] as const
...
const handleSearch = async (query: string) => {
  ...
  await recordSearch(query, searchType.value, totalResults.value, filters.value)
}
