...
describe("Priority Tier Management", () => {
  ...
  describe("schoolsByPriorityTier getter", () => {
    ...
    it("should return empty array for non-existent tier", () => {
      ...
      const noTier = schoolStore.schools.filter(s => s.priority_tier === null)
...
```typescript
import { validateSchoolNotes, MAX_SCHOOL_NOTES } from "~/utils/validators/schoolValidation"
...
describe("School Sorting", () => {
  ...
  beforeEach(() => {
    ...
    schoolStore.schools = [
      createMockSchool({ id: "1", name: "ASU", distance: 500, updated_at: "2026-01-20" }),
      createMockSchool({ id: "2", name: "CU", distance: 100, updated_at: "2026-01-23" }),
      createMockSchool({ id: "3", name: "CSU", distance: 50, updated_at: "2026-01-21" })
    ]
