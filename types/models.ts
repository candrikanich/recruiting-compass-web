...
export interface Event {
  ...
  event_source?: 'email' | 'flyer' | 'web_search' | 'recommendation' | 'friend' | 'other' | null
...
export interface PerformanceMetric {
  ...
  user_id?: string
  recorded_date: string
  metric_type: 'velocity' | 'exit_velo' | 'sixty_time' | 'pop_time' | 'batting_avg' | 'era' | 'strikeouts' | 'other'
  value: number
  unit: string
  event_id?: string | null
  notes?: string | null
...
export interface Offer {
  ...
  user_id?: string
  school_id: string
  offer_type: 'full_ride' | 'partial' | 'scholarship' | 'recruited_walk_on' | 'preferred_walk_on'
...
export interface Notification {
  ...
  title: string
  message: string
  related_entity_type?: 'offer' | 'event' | 'recommendation' | 'coach' | 'school' | 'interaction' | null
...
export interface InteractionAutomation {
  ...
  action: 'create_reminder' | 'send_email' | 'log_interaction' | 'update_status'
