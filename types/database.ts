...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      interactions_backup_pre_family: {
        Row: {
          ...
          created_at: string | null;
          direction:
            Database["public"]["Enums"]["interaction_direction"] | null;
          event_id: string | null;
          family_unit_id: string | null;
          id: string | null;
      ...
      recommendation_letters: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recommendation_letters_family_unit_id_fkey";
            columns: ["family_unit_id"];
            isOneToOne: false;
            referencedRelation: "family_units";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      user_is_family_member: { Args: { family_id: string }; Returns: boolean };
    };
    Enums: {
      ...
      interaction_sentiment:
        "positive" | "neutral" | "negative" | "very_positive";
      interaction_type:
        | "email"
        | "text"
        | "phone_call"
      ...
      recommendation_status:
        "not_requested" | "requested" | "received" | "submitted";
