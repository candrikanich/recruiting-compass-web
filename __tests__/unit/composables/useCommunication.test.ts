...
describe('useCommunication', () => {
  ...
  describe('State Management', () => {
    it('should initialize with correct default state', () => {
      const { showPanel, selectedCoach, communicationType } = useCommunication()
  ...
  describe('openCommunication', () => {
    it('should set selectedCoach and communicationType for email', () => {
      const { openCommunication, showPanel, selectedCoach, communicationType } = useCommunication()
    ...
    it('should update state when called multiple times', () => {
      const { openCommunication, selectedCoach, communicationType } = useCommunication()
  ...
  describe('handleInteractionLogged', () => {
    ...
    it('should close panel and reset state after successful interaction', async () => {
      const { openCommunication, handleInteractionLogged, showPanel, selectedCoach } = useCommunication()
    ...
    it('should use subject from interactionData if provided', async () => {
      ...
      expect(mockCreateInteraction.mock.calls[0][0].subject).toBe('Custom Subject')
    })
    ...
    it('should use content field if provided', async () => {
      ...
      expect(mockCreateInteraction.mock.calls[0][0].content).toBe('Email content field')
    })
    ...
    it('should fallback to body field if content not provided', async () => {
      ...
      expect(mockCreateInteraction.mock.calls[0][0].content).toBe('Email body field')
    })
    ...
    it('should prefer content over body if both provided', async () => {
      ...
      expect(mockCreateInteraction.mock.calls[0][0].content).toBe('Content field')
    })
  })
