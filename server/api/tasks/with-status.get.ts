...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const getAthleteTaskId = (at: any): string | undefined => {
      return (typeof at === 'object' && at !== null && 'task_id' in at && typeof at.task_id === 'string') ? at.task_id : undefined
    }
    ...
    const merged = (Array.isArray(tasksData) ? tasksData : []).map((task: any) => {
