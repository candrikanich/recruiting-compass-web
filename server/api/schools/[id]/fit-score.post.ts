...
export default defineEventHandler(async (event) => {
  ...
  if (body.athleticFit !== undefined && (typeof body.athleticFit !== 'number' || body.athleticFit < 0 || body.athleticFit > 40)) {
    throw createError({
      statusCode: 400,
  ...
  if (body.academicFit !== undefined && (typeof body.academicFit !== 'number' || body.academicFit < 0 || body.academicFit > 25)) {
    throw createError({
      statusCode: 400,
  ...
  if (body.opportunityFit !== undefined && (typeof body.opportunityFit !== 'number' || body.opportunityFit < 0 || body.opportunityFit > 20)) {
    throw createError({
      statusCode: 400,
  ...
  if (body.personalFit !== undefined && (typeof body.personalFit !== 'number' || body.personalFit < 0 || body.personalFit > 15)) {
    throw createError({
      statusCode: 400,
