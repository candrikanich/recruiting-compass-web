 ...
 * profile: both the athlete and their parent can trigger this, always
 * scoped to the athlete's own record (resolveAthleteId). Audit log
 * attributes the write to the actual caller (user.id), not the athlete.
 */
