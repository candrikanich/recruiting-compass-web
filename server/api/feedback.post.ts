...
import { sanitizeExternalApiError, createSafeErrorResponse } from '~/server/utils/errorHandler'
...
export default defineEventHandler(async (event) => {
  try {
    ...
    const feedbackTypeLabel = validated.feedbackType === 'bug' ? 'Bug Report' :
                             validated.feedbackType === 'feature' ? 'Feature Request' : 'Other Feedback'
