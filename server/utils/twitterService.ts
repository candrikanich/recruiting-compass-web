...
export class TwitterService {
  ...
  async getUserTweets(
    ...
    try {
      ...
      const userData = await userResponse.json() as { data: { id: string; username: string; name: string } }
   ...
   */
  async fetchTweetsForHandles(handles: string[]): Promise<SocialMediaPostData[]> {
