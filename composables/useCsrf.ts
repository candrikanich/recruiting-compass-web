...
export function useCsrf(): {
  ...
  post: (url: string, body?: Record<string, any>, options?: FetchOptions) => Promise<any>
  put: (url: string, body?: Record<string, any>, options?: FetchOptions) => Promise<any>
  patch: (url: string, body?: Record<string, any>, options?: FetchOptions) => Promise<any>
